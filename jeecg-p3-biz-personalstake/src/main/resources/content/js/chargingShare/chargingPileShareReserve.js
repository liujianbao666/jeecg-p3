...
function tableInit(){
	$("#chargingPileShareReserveTable").bootstrapTable({
        url: 'chargingPileShareController.do?getChargingPileShareReserveByTgNo',         //请求后台的URL（*）
        method: 'get',                      //请求方式（*）
        ...
        columns:[
                ...
                {field:'stakeAddress',halign:"center",title:'充电桩地址',width:300,align:"left"},
                ...
                {field:'reserveTime',halign:"center",title:'预约时间',width:150,align:"center"},
                {field:'userid',halign:"center",title:'预约用户ID',width:150,align:"center"},
                {field:'reservePeroid',halign:"center",title:'预约期限（分钟）',width:150,align:"center"}
...
//                    }}
			    ...
			    onLoadSuccess: function(data){  //加载成功时执行
	  				...
	  				if(data.total==0){
	  					...
	  					$("#chargingPileShareReserveTable").bootstrapTable('load',{rows:[{},{},{},{},{},{},{},{},{},{}],total:0})
	  				}
...
function refreshRunTable(){
    $('#chargingPileShareReserveTable').bootstrapTable('refresh');
}
