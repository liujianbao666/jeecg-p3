		  ...
		  success:function(data){
			  var option = {
					    ...
					    legend: {
					        ...
					        //data: ['有序充电量(kW·h)','正常充电量(kW·h)','居民用电量(kW·h)'],
					        data: ['有序充','正常充','居民'],
					        x: "left",
					        y: "bottom",
					        textStyle: {
		...
		async : false,   //设置为false。请求为同步请求
		  ...
		  success:function(data){
			  ...
			  option1.series[0].data=[
					{value:data.yesOd, name:'满足充电'},
					{value:data.notOd, name:'未满足充电'}];
			  orderChart1.setOption(option1);
			  
			  var option2 = orderChart2.getOption();
			  option2.series[0].data=[
					{value:data.optimalOd, name:'有序充'},
				    {value:data.normalOd, name:'正常充'}]
	...
	$.ajax({
		async : false,   //设置为false。请求为同步请求
		  ...
		  success:function(data){
			...
			orderChart1.setOption(option1);
			window.onresize = orderChart1.resize;
			...
			orderChart2.setOption(option2);
			window.onresize = orderChart2.resize;
	  }
	});
