...
$(document).ready(function(){
	...
	$("#container").attr("style","height:"+window.screen.height*0.75+"px;width:100%");
	...
	$.ajax({
		...
		success : function(data) {
			...
			if(data.allCap){
				...
				var num = data.allCap.length; //充电计划点的数量
				...
				if(num<10){
					...
					startLocation = (1-10/num).toFixed(2)*100;  //开始的x轴位置
				}
...
function clickT(url,title){
	var url="/SESS/personalstake/plan.do?lifeCycle&orderId="+orderId;
