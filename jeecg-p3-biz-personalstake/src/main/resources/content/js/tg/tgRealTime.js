...
$(document).ready(function(){
	...
	getTgCurves();
	setInterval(refreshTgCurves,6000); //60秒刷新
	//查询
	...
	$.ajax({   
		  ...
		  success:function(data){
		     ...
		     //更新数据
		      ...
		      option.series[1].data = data.pLim;  
		      option.series[2].data = data.pStart;
		      option.series[3].data = data.piesPower;
		      charts.setOption(option); 
		  }
	});
}
