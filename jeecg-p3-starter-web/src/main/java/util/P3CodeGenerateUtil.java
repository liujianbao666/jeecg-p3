...
public class P3CodeGenerateUtil {
	...
	public static void main(String[] args) {
		//表名（多个表可用逗号隔开）
		String code_cg_tables = "his_cg_i_curve_data,his_cg_p_curve_data,his_cg_u_curve_data";
		
		//执行代码生成器
		for (String tableName : code_cg_tables.split(",")) {
			CodeGenerateFactory.codeGenerateByFTL(tableName, "充电桩历史曲线", FtlDef.KEY_TYPE_02);
		}
	}
}
